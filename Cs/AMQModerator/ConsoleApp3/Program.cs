...
namespace ConsoleApp3
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            DataTest1<int>? dataTest = JsonSerializer.Deserialize<DataTest1<int>>(aa);
            DataTest1<double>? dataTest1 = JsonSerializer.Deserialize<DataTest1<double>>(aa);
            DataTest1<double>? dataTest2 = JsonSerializer.Deserialize<DataTest1<double>>(aa1);
